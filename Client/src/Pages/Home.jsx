          ...
          <nav className="fixed w-full z-50 bg-orange-50 dark:bg-gray-800 shadow-lg">
              ...
              <div className="flex justify-between h-20">
                <div className="left-0 flex-shrink-0 flex items-center">
                  <h1 className="text-3xl font-bold text-orange-600 dark:text-orange-400">
                    Canteen <span className="text-slate-600 dark:text-white font-bold">Connect</span>
                  </h1>
                </div>
                ...
                <div className="hidden md:flex items-center space-x-5">
                  ...
                  <button onClick={() => setShowSignUpModal(true)} className="px-4 py-2 text-xl font-semibold text-white bg-orange-500 hover:bg-orange-600 rounded-lg">
                    Sign Up
                  </button>
                </div>

                <div className="md:hidden flex items-center">
                  <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            ...
            <div className={`md:hidden transition-all duration-300 ease-in-out ${mobileMenuOpen ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <button onClick={() => { setShowSignUpModal(true); setMobileMenuOpen(false); }} className="w-full text-left px-3 py-2 rounded-md text-base font-medium text-white bg-orange-500 hover:bg-orange-600 transition-colors">
                  Sign Up
                </button>
              </div>
            </div>
