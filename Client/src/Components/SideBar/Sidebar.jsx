...
import { LuLayoutDashboard, LuUtensils } from 'react-icons/lu';
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className={`flex flex-row gap-2 text-xl md:text-2xl font-bold tracking-tight duration-500 transition-colors`}
          >
          ...
          >
            <FaRegArrowAltCircleLeft
              className={`h-5 w-5 ${darkMode ? 'text-white' : 'text-gray-800'}`}
            />
          </button>
        </div>
        ...
        <div className='absolute bottom-5 w-full px-4'>
          {isOpen && (
            <button
              ...
              className={`w-full flex items-center justify-center space-x-2 py-3 rounded-lg transition-colors mt-2 ${
                darkMode ? 'bg-red-500 text-white' : 'bg-slate-400 text-white'
              } hover:bg-red-600`}
            >
              <span>Sign Out</span>
            </button>
